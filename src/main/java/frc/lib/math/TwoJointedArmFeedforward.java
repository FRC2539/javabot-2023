...
public class TwoJointedArmFeedforward {
     ...
     * @param freeSpeed
     */
    public TwoJointedArmFeedforward(double length1, double length2, double com1, double com2, double mass1, double mass2, double momentOfInertia1, double momentOfInertia2, double gearRatio1, double gearRatio2, double nMotors1, double nMotors2, double stallTorque, double stallCurrent, double freeSpeed, double gravity) {
        l1 = length1;
        l2 = length2;
        r1 = com1;
        r2 = com2;
    ...
    private Matrix<N2, N2> calculateArmInertiaMatrix(Matrix<N2, N1> motorAngles) {
        ...
        return new MatBuilder<N2, N2>(Nat.N2(), Nat.N2()).fill(
    ...
    private Matrix<N2, N2> calculateCoriolisMatrix(Matrix<N2, N1> motorSpeeds, Matrix<N2, N1> motorAngles) {
        ...
        double dth1 = motorSpeeds.get(1, 1);
        double dth2 = motorSpeeds.get(2, 1);
    ...
    public double[] calculateFeedforwardVoltages(double joint1Acceleration, double joint2Acceleration, double joint1Speed, double joint2Speed, double joint1Angle, double joint2Angle) {
        ...
        return new double[]{voltages.get(1,1), voltages.get(2, 1)};
    }

    private Matrix<N2, N1> calculateFeedforwardVoltageMatrix(Matrix<N2, N1> motorAccelerations, Matrix<N2, N1> motorSpeeds, Matrix<N2, N1> motorAngles) {
    ...
    private Matrix<N2, N1> calculateGravityMatrix(Matrix<N2, N1> motorAngles) {
        ...
        return new MatBuilder<N2, N1>(Nat.N2(), Nat.N1()).fill(
            (m1 * r1 + m2 * l1) * g * c.a(1) + m2 * r2 * g * c.a(1,2),
            m2 * r2 * g * c.a(1,2)
        );
    }
    ...
    private GcOrsFunction csLambdaCreator(Matrix<N2, N1> motorAngles, boolean isCosine) {
        double theta1 = motorAngles.get(1, 1);
        double theta2 = motorAngles.get(2, 1);
